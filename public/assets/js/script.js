		...
		Basic: {
			...
			EiStickyMenu: function (){
				...
				if($('.appi-ei-mobile_menu li.dropdown ul').length){
					$('.appi-ei-mobile_menu li.dropdown').append('<div className="dropdown-btn"><span className="fa fa-angle-down"></span></div>');
			...
			EiServiceSLider: function (){
				if($('.ei-service-slide').length){
					var customPagerSlider = $(".ei-service-slide").bxSlider({
						...
						pause: 5000,
						speed: 1000,
						nextText: '<span className="control-icon fa fa-angle-right"></span>',
						prevText: '<span className="control-icon fa fa-angle-left"></span>',
			...
			AppSeoMobileMenu: function (){
				...
				if($('.appseo-mobile_menu li.dropdown ul').length){
					$('.appseo-mobile_menu li.dropdown').append('<div className="dropdown-btn"><span className="fa fa-angle-down"></span></div>');
			...
			SaaSCMobileMenu: function (){
				...
				if($('.s2-mobile_menu li.dropdown ul').length){
					$('.s2-mobile_menu li.dropdown').append('<div className="dropdown-btn"><span className="fa fa-angle-down"></span></div>');
			...
			StrMobileMenu: function (){
				...
				if($('.str-mobile_menu li.dropdown ul').length){
					$('.str-mobile_menu li.dropdown').append('<div className="dropdown-btn"><span className="fa fa-angle-down"></span></div>');
			...
			DiaMobileMenu: function (){
				...
				if($('.dia-mobile_menu li.dropdown ul').length){
					$('.dia-mobile_menu li.dropdown').append('<div className="dropdown-btn"><span className="fa fa-angle-down"></span></div>');
			...
			PmMobileMenu: function (){
				...
				if($('.pm-mobile_menu li.dropdown ul').length){
					$('.pm-mobile_menu li.dropdown').append('<div className="dropdown-btn"><span className="fa fa-angle-down"></span></div>');
