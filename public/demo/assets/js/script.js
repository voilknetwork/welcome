...
(function() {
	...
	var Popular = {
		...
		Basic: {
			...
			CountDown: function (){
				// $('.countdown ul').downCount({
				// 	date: '06/21/2021 12:00:00',
				// 	offset: +6
				// }, function () {
			...
			ReviewSlider: function (){
				$(".review-slider").slick({
					...
					autoplay: false, 
					speed: 1000,
					prevArrow: '<button className="slick-prev"><i className="fas fa-arrow-left"></i></button>',
					nextArrow: '<button className="slick-next"><i className="fas fa-arrow-right"></i></button>',
